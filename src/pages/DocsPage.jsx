...
function DocsPage() {
  ...
  const navigationItems = [
    ...
    { id: 'javascript-optimization', title: 'JavaScript Optimization', level: 2 },
        ...
        <main className="docs-content">
          <header className="docs-header">
            ...
            <p className="docs-intro">
              Complete API reference, tutorials, and integration guides for OptimizeCode.ai. 
              Get started with AI-powered code optimization in minutes.
            </p>
          </header>
          ...
          <section id="getting-started" className="doc-section">
            ...
            <p>
              OptimizeCode.ai provides multiple ways to integrate AI-powered code optimization 
              into your development workflow. Choose the method that best fits your needs.
            </p>
...
optimize-code input.js --output optimized.js"
          ...
          <section id="api-reference" className="doc-section">
            <h2>📚 API Reference</h2>
            <p>
              The OptimizeCode.ai REST API allows you to integrate code optimization 
                ...
                code={`// Successful optimization response
{
  ...
  "size_reduction": "23%"
          ...
          <section id="integrations" className="doc-section">
            <h2>🔧 Integrations</h2>
            <p>
              OptimizeCode.ai integrates seamlessly with your existing development tools 
              and workflows.
            </p>

            <div id="github-app" className="subsection">
              <h3>GitHub App</h3>
              <p>Install the GitHub App to automatically optimize pull requests:</p>
              <ol>
                <li>Go to the GitHub Marketplace</li>
                <li>Search for "OptimizeCode.ai"</li>
                <li>Install on your repositories</li>
                <li>Configure optimization rules in <code>.optimizecode.yml</code></li>
              </ol>
              <CodeBlock
                language="yaml"
        ...
        env:
          ...
          <section id="tutorials" className="doc-section">
            ...
            <div id="javascript-optimization" className="subsection">
              ...
              <p>Learn how to optimize JavaScript code for better performance:</p>
  ...
  return users
    ...
    .filter(pair => pair.manager);
            ...
            <div id="python-performance" className="subsection">
              ...
              <p>Optimize Python code for better performance and memory usage:</p>
              <CodeBlock
                language="python"
...
def process_data(items):
    return sum(x**2 for x in items if x > 0)`}
            ...
            <div id="cicd-integration" className="subsection">
              ...
              <p>Set up automated code optimization in your deployment pipeline:</p>
              <CodeBlock
                language="bash"
                code={`#!/bin/bash
